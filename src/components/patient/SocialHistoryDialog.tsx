...
export function SocialHistoryDialog({
  open,
  onOpenChange,
  onInsert,
                ...
                {RECREATIONAL_DRUGS.map((drug) => (
                  <div key={drug} className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={() =>
                        toggleSelection(drug, selectedDrugs, setSelectedDrugs)
                      }
                    />
                ...
                {DIET_OPTIONS.map((diet) => (
                  <div key={diet} className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={() =>
                        toggleSelection(diet, selectedDiet, setSelectedDiet)
                      }
                    />
                ...
                {LIVING_ENVIRONMENT_OPTIONS.map((env) => (
                  <div key={env} className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={() =>
                        toggleSelection(env, selectedLiving, setSelectedLiving)
                      }
                    />
