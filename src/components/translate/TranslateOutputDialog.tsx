...
interface TranslateOutputDialogProps {
  open: boolean;
...
export function TranslateOutputDialog({
  open,
  onOpenChange,
  translatedText,
  targetLanguage,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh]">
        <DialogHeader>
          <DialogTitle>Translated Text</DialogTitle>
          <DialogDescription>
            Translation to {targetLanguage} - Review and choose where to insert
          </DialogDescription>
        </DialogHeader>
        <Card className="my-4">
